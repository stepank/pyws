...
it. Therefore we need a lot of tests, which will prove interoperability. Here
is an instruction, how to run them.

In any case you need a pyws server running. The easiest way to do this is::

    cd [pyws_dir]/examples/_django
    python manage.py runserver

This will run a server based on Django, so, of course, you need to have Django
installed. I tested it on Django 1.3. The server will be running on your
localhost, port 8000.
...
Surely, you need to have PHP installed, I use PHP 5.3.3. You need to have
...
Of course, you need to have Java installed, I use Java 1.6.0_26. You also need
...
You need to have suds and unittest2 installed.
...
Requirements are the same as for Axis integration tests, except that you don't
need JUnit, but you do need an XSLT 2.0 processor. I use Saxon B 0.9, if you
...
This script will generate ``report.xml`` file. All you have to do is to open
